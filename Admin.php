...
<div style="background-image: url('gambar/Desktop.gif'); 
  ...
  <center>
	...
	<br>
      <div class="alert alert-success" role="alert" style="<?php
                if(isset($_SESSION['pesan_adm_berhasil'])){
                  echo $_SESSION['pesan_adm_berhasil'];
                  unset($_SESSION['pesan_adm_berhasil']);
                  }else{
                  echo "display:none;"; 
                  }
                  ?>">Admin Ditambahkan<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
        </div>
        <div class="alert alert-danger" role="alert" style="<?php
                if(isset($_SESSION['pesan_adm_hapus'])){
                  echo $_SESSION['pesan_adm_hapus'];
                  unset($_SESSION['pesan_adm_hapus']);
                  }else{
                  echo "display:none;"; 
                  }
                  ?>">Admin Dihapus<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
        </div>
        <div class="alert alert-warning" role="alert" style="<?php
                if(isset($_SESSION['pesan_adm_ubah'])){
                  echo $_SESSION['pesan_adm_ubah'];
                  unset($_SESSION['pesan_adm_ubah']);
                  }else{
                  echo "display:none;"; 
                  }
                  ?>">Admin Diubah<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
        </div>
	<br>
	<!-- table barang -->
	<div class="container">
		<div align="left"><a href="register.php" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>
		&nbsp;&nbsp;
		<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;Admin</a><div align="right">
  ...
  <?php 
  if (isset($_POST['cari'])) {
    require ('result_admin.php');
  }else{
    unset($_POST['cari']);
    require ('Tampil_table_admin.php');
